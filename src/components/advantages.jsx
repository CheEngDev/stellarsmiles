...
const Advantages = () => {
  return (
    <div className="mt-40">
      ...
      <div className="mt-16 md:mt-20 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-2 md:px-2 lg:gap-2  lg:grid-cols-4 lg:grid-rows-1  ">
        ...
        <div className="mt-5  flex flex-col items-center md:mt-4 lg:mt-0">
